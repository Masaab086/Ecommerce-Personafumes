...
const TermsAndCondition: NextPage<TermsConditionProps> = ({
  isLightTheme,
  products,
}) => {
  return (
    <main
      ...
      <section className="w-4/5 mx-auto mt-10">
        ...
        <section>
          ...
          <div>
            ...
            <ol className="list-decimal ml-10">
              ...
              <li className="my-1">
                <span className="font-bold">Country</span> refers to: Florida,
                United States
              </li>
              <li className="my-1">
                <span className="font-bold">Company</span> (referred to as
                either &quot;the Company&quot; , &quot;We&quot; , &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Personafumes,
                USA
              </li>
              <li className="my-1">
              ...
              <li className="my-1">
                <span className="font-bold">Goods</span> refer to the items
                offered for sale on the Service.
              </li>
              <li className="my-1">
                <span className="font-bold">Orders</span> mean a request by You
                to purchase Goods from Us.
              </li>
              <li className="my-1">
                <span className="font-bold">Promotions</span> refer to contests,
        ...
        <section>
          ...
          <div>
            <h3 className="text-lg font-bold mt-4 mb-1">Your Information</h3>
            <p className="my-2">
          ...
          <div>
            <h3 className="text-lg font-bold mt-4 mb-1">Order Cancellation</h3>
            <p className="my-2">
              We reserve the right to refuse or cancel Your Order at any time
              for certain reasons including but not limited to:
            </p>
            <ul className="list-disc ml-10">
              <li className="my-1">Goods availability</li>
              <li className="my-1">
                Errors in the description or prices for Goods
              </li>
              <li className="my-1">Errors in Your Order</li>
            </ul>
            <p className="my-2">
        ...
        <section>
          <h1 className="text-2xl font-bold mt-8 mb-2 underline">Promotions</h1>
          <p className="my-2">
        ...
        <section>
          ...
          <div>
            <h3 className="text-lg font-bold mt-4 mb-1">Severability</h3>
            <p className="my-2">
          ...
          <div>
            <h3 className="text-lg font-bold mt-4 mb-1">Waiver</h3>
            <p className="my-2">
        ...
        <section>
          ...
          <ul className="list-disc ml-10">
            <li className="my-1">By email: admin@personafumes.com</li>
          </ul>
        </section>
      </section>
