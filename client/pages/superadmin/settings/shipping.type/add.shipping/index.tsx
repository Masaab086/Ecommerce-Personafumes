...
const AddShipping: React.FC<AddShippingProps> = ({
  sideBarDisplay,
  setSideBarDisplay,
  setShippingData,
}) => {
  ...
  const handleAddShipping = (data: ShippingTypeModal) => {
    setBtnClick(true);
    axios
      .post(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/shipping`, data)
      .then(({ data }) => {
        setBtnClick(false);
    ...
    <>
      ...
      >
        <div className="h-[64px] p-1 px-3 flex justify-between items-center">
          <div>
            <div>Add Shipping</div>
            <div>Add your shipping and necessary information from here</div>
          </div>
        ...
        {/* Inputs section */}
        <form onSubmit={handleSubmit(handleAddShipping)}>
              ...
              <div className="col-span-2">
                <div className="my-2 flex flex-col">
                  <select
                    ...
                    // {...register(`shipping.${index}.country`)}
                  >
