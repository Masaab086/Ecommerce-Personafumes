...
const Products: NextPage = () => {
  ...
  return (
    <SuperAdminLayout title="Bottles" tab={2}>
      <div>
        <div className="p-4 flex justify-between bg-[#222328] my-5 border border-[#363434] rounded-md">
          ...
          {/* <select className="bg-transparent px-4 py-1 border border-[#938E8E] rounded-md">
          ...
          <button
            className="bg-[#DBC864] text-black font-bold rounded-md px-10 py-2 "
        ...
        <div className="my-2 bg-[#222328]">
          <div className=" border border-[#363434] grid grid-cols-5 gap-6 p-4">
            <button className="border border-dashed col-span-3 rounded-lg	 border-[#DBC864] py-1 px-3  text-l">
              Drop CSV File
            </button>
            <button className=" bg-white text-black rounded-md font-bold  py-1 px-3 ">
              Upload
            </button>
            <button className="rounded-md	 bg-[#DBC864] text-black font-bold py-1 px-3 ">
              Download
            </button>
          </div>
                      ...
                      <td className="py-1 px-2 text-center">
                        <div
                          ...
                          onClick={(): Promise<boolean> =>
                            router.push(
                              "/superadmin/products/" + data?.bottleId
                            )
                          }
                        >
