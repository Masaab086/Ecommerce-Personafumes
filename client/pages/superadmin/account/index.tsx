...
const Account: NextPage<AccountProps> = ({ products }) => {
  ...
  return (
    <SuperAdminLayout title="Personal Information" tab={10}>
      <div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <select
                      className="form-select appearance-none block w-6/12 px-3 py-1.5 font-normal bg-black text-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none"
